...
<font color="red">D、再利用できるのは、一度だけである。</font>

５、Webブロックはどこで使用できますか。

<font color="red">A、Web画面内とWebブロック内（そのWebブロック自体は除く）。</font>
...
<font color="red">C、WebブロックのPreparationが実行され、Webブロックが更新される。</font>
